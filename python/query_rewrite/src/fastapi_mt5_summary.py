...
from transformers import T5Tokenizer, MT5ForConditionalGeneration, AutoTokenizer, AutoModelForSeq2SeqLM
...
@app.post('/rewrite')
async def rewrite(query: str = Body('', title='原文', embed=True),
    ...
    inputs = tokenizer.encode_plus(
        query, max_length=128, padding='max_length', truncation=True, return_tensors='pt')
    # print(inputs)
    if is_beam_search:
